...
class UILoader(BasicDataset):
    def __init__(self, config=Kg_Par.config, path="../datasets/."):
        ...
        self.g["train_u"] = self.trainUser
        self.g["train_i"] = self.trainItem
        self.g["test_u"] = self.testUser
        self.g["test_i"] = self.testItem
        self.g["userNum"] = self.n_user
        self.g["itemNum"] = self.m_item
